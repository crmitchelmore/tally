...
**Subtitle (<= 30 chars):** Track habits & challenges

**Promotional text (optional):**
Progress that feels good: quick adds, calm stats, and challenges you’ll actually stick with.

**Description:**
Tally helps you track challenges, habits, and goals with the simplest possible action: add a mark.
...
**Keywords (idea list):**
habit tracker, challenge tracker, streak, goal tracker, progress, tally, counter, routine
...
Track habits and challenges with quick tally marks, totals, and calm stats.
...
- Designed to be calm, readable, and accessible

**Tags (idea list):**
Habits, Productivity, Health & Fitness
...
4. Stay motivated with clear goals
5. Calm, friendly design that’s easy to use
