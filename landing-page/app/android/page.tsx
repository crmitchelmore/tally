        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">
              Tally for Android is coming soon.
            </h1>
            <p className="mt-6 text-lg text-slate-600">
              Built with Jetpack Compose for fast, tactile logging and offline-first resilience.
              We&apos;ll share the Play Store link as soon as it&apos;s ready.
            </p>
          ...
          <div className="rounded-[28px] border border-slate-200/70 bg-white/90 p-6 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.35)]">
            ...
            <p className="mt-4 text-sm text-slate-600">
              Store preview coming soon. Expect the same calm pace cues and tally marks.
            </p>
          </div>
        </div>
      </section>
