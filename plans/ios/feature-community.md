# Feature: Community (iOS)

## Goal
Browse public challenges and follow others.

## Scope
- Public challenges list with search.
- Follow/unfollow actions.
- Following section in dashboard.

## Acceptance criteria
- Follow state persists and syncs.
- Private challenges are hidden.
...
- Implement as a Swift package (e.g. `TallyFeatureCommunity`) and keep the app target as composition glue.
