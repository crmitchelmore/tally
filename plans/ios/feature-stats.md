...
- Yearly activity heatmap (grid) + charts (Swift Charts).
...
- Implement as a Swift package (e.g. `TallyFeatureStats`) and keep the app target as composition glue.
