# Feature: Testimonials + stats

## Goal
Build trust quickly without noise.

## Scope
- 2-3 short quotes or metrics.
- Lightweight logos or badges if available.

## Acceptance criteria
- Section loads fast and stays visually calm.
