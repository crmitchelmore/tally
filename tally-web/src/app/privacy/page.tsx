...
export default function Privacy() {
  return <main className="mx-auto max-w-2xl px-6 py-16 space-y-6">
    ...
    <p>Tally is a general-purpose progress tracker and is not directed at children under 13. Goals are private in the current release; public community sharing is unavailable. We will update this page when our practices change.</p>
