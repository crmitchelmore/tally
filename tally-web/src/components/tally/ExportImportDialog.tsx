...
import { Upload, FileJson, FileText, AlertTriangle, CheckCircle2, Info, X } from 'lucide-react'
                  ...
                  <div className="mb-4 p-3 rounded-lg bg-muted/50">
                    <div className="text-sm space-y-1">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold font-mono">{challenges.length}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Entries:</span>
                        <span className="font-semibold font-mono">{entries.length}</span>
                      </div>
                    </div>
                  </div>
